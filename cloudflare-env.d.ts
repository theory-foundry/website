/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.example --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 412312fb94c2be0f2356df243b737d45)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAI_API_KEY" | "NEXT_PUBLIC_TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET" | "TURNSTILE_HOSTNAMES" | "CHAT_IP_HASH_SECRET" | "CHAT_DAILY_LIMIT">> {}
}
