/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.example --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: f777edea9c356c7bd4a6bad686ff1c46)
// Runtime types generated with workerd@1.20260722.1 2026-07-26 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	CHAT_RATE_LIMIT_DB: D1Database;
	ASSETS: Fetcher;
	TURNSTILE_HOSTNAMES: "theoryfoundry.com";
	CHAT_DAILY_LIMIT: "10";
	OPENAI_MODEL: "gpt-5.6-luna";
	OPENAI_API_KEY: string;
	TURNSTILE_SECRET: string;
	CHAT_IP_HASH_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURNSTILE_HOSTNAMES" | "CHAT_DAILY_LIMIT" | "OPENAI_MODEL" | "OPENAI_API_KEY" | "TURNSTILE_SECRET" | "CHAT_IP_HASH_SECRET">> {}
}
